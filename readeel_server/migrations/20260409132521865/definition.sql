...
--
-- Class Excerpt as table excerpts
--
...
--
-- Foreign relations for "excerpts" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('readeel', '20260409132521865', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260409132521865', "timestamp" = now();
