...
abstract class AppLocalizations {
  ...
  /// Option to use system default setting
  ///
  /// In en, this message translates to:
  /// **'System Default'**
  String get systemDefault;

  /// Option to use light mode
  ///
  /// In en, this message translates to:
  /// **'Light Mode'**
  ...
  /// Section header for content settings
  ///
  /// In en, this message translates to:
  /// **'Content'**
  String get content;

  /// Label for feed language selection
  ///
  /// In en, this message translates to:
  /// **'Feed Language'**
